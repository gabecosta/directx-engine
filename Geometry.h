...
public:
    ...
    float Ax() const { return x + (a.X() * scale); }    
    float Ay() const { return y + (a.Y() * scale); }    
    float Bx() const { return x + (b.X() * scale); }    
    float By() const { return y + (b.Y() * scale); }   
...
public:
    ...
    float Left() const   { return x + (left*scale);   } 
    float Top() const    { return y + (top*scale);    } 
    float Right() const  { return x + (right*scale);  } 
    float Bottom() const { return y + (bottom*scale); } 
...
public:
    ...
    float Radius() const { return radius * scale; }     
